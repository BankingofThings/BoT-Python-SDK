...
if __name__ == "__main__":
    ...
    Logger.info(Component, 'Set Offline MODE')
    BotSDKHndl.enableOfflineMode()
...
#        Logger.error(BoT_Application, Error.msg)
    ...
    except BotSDK.NetworkUnavailableError as Error:
        Logger.error(Component, Error.msg)
    ...
    try:
      ...
      Logger.error(Component, Error.msg)
        ...
        Logger.error(Component, Error.msg)
    except BotSDK.ActionsTriggerStoreError as Error:
        Logger.error(Component, Error.msg)
    except BotSDK.ServiceUnavailableError as Error:
        Logger.error(Component, Error.msg)
